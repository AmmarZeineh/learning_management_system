...
import 'package:learning_management_system/widgets/insturactor/upload_videos_and_files_container.dart';
    ...
    return BlocBuilder<BottomSheetCubit, BottomSheetState>(
      builder: (context, state) {
        if (state is BottomSheetInitial) {
                          ...
                          onPressed: () async {
                            if (formKey.currentState!.validate()) {
                              ...
                              try {
                                ...
                                showSnackBar(
                                    context, 'Questions Created Successfully');
                                BlocProvider.of<BottomSheetCubit>(context)
          ...
          return BlocBuilder<UploadFilesAndVideosCubit,
                                ...
                                if (formKey.currentState!.validate()) {
                                  ...
                                  try {
                                    await BlocProvider.of<
                                            UploadFilesAndVideosCubit>(context)
                                        .uploadFilesToCourse(
                                            videosPaths: BlocProvider.of<
                                                        UploadFilesAndVideosCubit>(
                                                    context)
                                                .videoPaths,
                                            pdfsPaths: BlocProvider.of<
                                                        UploadFilesAndVideosCubit>(
                                                    context)
                                                .pdfPaths,
                                            courseId: BlocProvider.of<
                                                    BottomSheetCubit>(context)
                                                .courseId
                                                .toString());
